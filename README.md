...
<details>
  ...
  * Data de entrega para avaliação regular do projeto: `13/09/2023 14:00`.
...
⚠️ Configurar o `Dockerfile`, tanto para o _front-end_ quanto para o _back-end_, **não** é apenas o primeiro passo para garantir que sua aplicação execute corretamente. Além disso, será necessário criar as  _migrations_ e descomentar o underscore (`_`) nas _seeders_, para que o projeto seja executável via Docker. É importante lembrar que todos os containers do docker-compose só funcionarão corretamente quando pelo menos o requisito 1 tiver sido cumprido.
...
### 💡 Dicas:
  ...
  - Para que o docker-compose funcione corretamente, é imprescindível a criação dos Dockerfiles tanto para o front-end quanto para o back-end, além de fazer pelo menos o requisito 1;
